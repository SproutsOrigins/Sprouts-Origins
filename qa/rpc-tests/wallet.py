...
#   c) node1 mines 32 blocks, so now node 0 has 500000SPRO, node 1 has 4250SPRO, node2 has none.
#   d) node0 sends 601 SPRO to node2, in two transactions (301 SPRO, then 300 SPRO).
