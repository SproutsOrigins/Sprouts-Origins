...
"""Verify that starting Sprouts-Origins with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Sprouts-Origins with -? for help text")
        ...
        self.log.info("Start Sprouts-Origins with -version for version information")
