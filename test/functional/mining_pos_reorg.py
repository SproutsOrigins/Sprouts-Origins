...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected PIV and zSprouts supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check PIV and zSprouts supply at the beginning
        # ------------------------------------------
        # zSprouts supply: 2 coins for each denomination
        ...
        # Verify that PIV and zSprouts supplies were properly updated after the spends and reorgs
        self.log.info("Check Sprouts and zSprouts supply...")
