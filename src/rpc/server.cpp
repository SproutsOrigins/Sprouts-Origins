...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"Sprouts-Origins", "listmasternodes", &listmasternodes, true },
        {"Sprouts-Origins", "getmasternodecount", &getmasternodecount, true },
        {"Sprouts-Origins", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"Sprouts-Origins", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"Sprouts-Origins", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"Sprouts-Origins", "masternodecurrent", &masternodecurrent, true },
        {"Sprouts-Origins", "startmasternode", &startmasternode, true },
        {"Sprouts-Origins", "createmasternodekey", &createmasternodekey, true },
        {"Sprouts-Origins", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"Sprouts-Origins", "listmasternodeconf", &listmasternodeconf, true },
        {"Sprouts-Origins", "getmasternodestatus", &getmasternodestatus, true },
        {"Sprouts-Origins", "getmasternodewinners", &getmasternodewinners, true },
        {"Sprouts-Origins", "getmasternodescores", &getmasternodescores, true },
        {"Sprouts-Origins", "preparebudget", &preparebudget, true },
        {"Sprouts-Origins", "submitbudget", &submitbudget, true },
        {"Sprouts-Origins", "mnbudgetvote", &mnbudgetvote, true },
        {"Sprouts-Origins", "getbudgetvotes", &getbudgetvotes, true },
        {"Sprouts-Origins", "getnextsuperblock", &getnextsuperblock, true },
        {"Sprouts-Origins", "getbudgetprojection", &getbudgetprojection, true },
        {"Sprouts-Origins", "getbudgetinfo", &getbudgetinfo, true },
        {"Sprouts-Origins", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"Sprouts-Origins", "mnfinalbudget", &mnfinalbudget, true },
        {"Sprouts-Origins", "checkbudgets", &checkbudgets, true },
        {"Sprouts-Origins", "mnsync", &mnsync, true },
        {"Sprouts-Origins", "spork", &spork, true },
...
{
    return "> Sprouts-Origins-cli " + methodname + " " + args + "\n";
}
