...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,           (numeric) the total Sprouts-Origins balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zSproutssupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zSprouts denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zSprouts denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zSprouts denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zSprouts denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zSprouts denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zSprouts denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zSprouts denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zSprouts denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zSprouts denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,      (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,          (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,        (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,           (numeric) the transaction fee set in Sprouts-Origins/kb\n"
            "  \"relayfee\": x.xxxx,           (numeric) minimum relay fee for non-free transactions in Sprouts-Origins/kb\n"
    ...
    obj.push_back(Pair("zSproutssupply", zpivObj));
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"Sprouts-Originsaddress\"\n"
            "\nReturn information about the given Sprouts-Origins address.\n"

            "\nArguments:\n"
            "1. \"Sprouts-Originsaddress\"     (string, required) The Sprouts-Origins address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"type\" : \"xxxx\",              (string) \"standard\" or \"sapling\"\n"
            "  \"address\" : \"Sprouts-Originsaddress\",    (string) The Sprouts-Origins address validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded scriptPubKey generated by the address -only if is standard address-\n"
            "  \"ismine\" : true|false,          (boolean) If the address is yours or not\n"
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for Sprouts-Origins cold staking -only if is standard address-\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Sprouts-Origins address and we have full public key:
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are Sprouts-Origins addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) Sprouts-Origins address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"Sprouts-Originsaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"Sprouts-Originsaddress\"  (string, required) The Sprouts-Origins address to use for the signature.\n"
...
UniValue getstakingstatus(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"staking_enabled\": true|false,     (boolean) whether staking is enabled/disabled in Sprouts-Origins.conf\n"
            "  \"coldstaking_enabled\": true|false, (boolean) whether cold-staking is enabled/disabled in Sprouts-Origins.conf\n"
            "  \"haveconnections\": true|false,     (boolean) whether network connections are present\n"
            "  \"mnsync\": true|false,              (boolean) whether the required masternode/spork data is synced\n"
            "  \"walletunlocked\": true|false,      (boolean) whether the wallet is unlocked\n"
            "  \"stakeablecoins\": n                (numeric) number of stakeable UTXOs\n"
            "  \"stakingbalance\": d                (numeric) Sprouts value of the stakeable coins (minus reserve balance, if any)\n"
