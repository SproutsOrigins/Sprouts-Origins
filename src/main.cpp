...
#if defined(NDEBUG)
#error "Sprouts Origins cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uspro) are considered zero fee (for relaying and mining)
...
{
    RenameThread("sproutsorigins-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // SPRO: We use certain sporks during IBD, so check to see if they are
