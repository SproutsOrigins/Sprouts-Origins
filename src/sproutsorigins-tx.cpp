...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sprouts Origins Core sproutsorigins-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sproutsorigins-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sproutsorigins transaction") + "\n" +
                               "  sproutsorigins-tx [options] -create [commands]   " + _("Create hex-encoded sproutsorigins transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sproutsorigins transaction
