...
int nStakeTargetSpacing = 60; // Sprouts Origins: 1 minute blocks during POS (block 201+)
...
{
    // Sprouts Origins will hash in the transaction hash and the index number in order to make sure each hash is unique
