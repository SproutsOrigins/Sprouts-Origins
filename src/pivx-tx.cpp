...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sprouts-Origins Core Sprouts-Origins-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Sprouts-Origins-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Sprouts-Origins transaction") + "\n" +
                               "  Sprouts-Origins-tx [options] -create [commands]   " + _("Create hex-encoded Sprouts-Origins transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Sprouts-Origins transaction
