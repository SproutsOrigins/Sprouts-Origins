...
/** Utility functions used by the Sprouts-Origins Qt UI.
 */
namespace GUIUtil
{
...
// Render Sprouts-Origins addresses in monospace font
...
// Parse "Sprouts-Origins:" URI into recipient object, return true on successful parsing
