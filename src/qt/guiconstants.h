...
/* Sprouts-Origins GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Sprouts-Origins"
#define QAPP_ORG_DOMAIN "sappcoin.com"
#define QAPP_APP_NAME_DEFAULT "Sprouts-Origins-Qt"
#define QAPP_APP_NAME_TESTNET "Sprouts-Origins-Qt-testnet"
