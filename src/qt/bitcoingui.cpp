...
// Copyright (c) 2017-2020 The Sprouts Origins Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Sprouts Origins Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SPRO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sproutsorigins: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Sprouts Origins Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sprouts Origins Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Sprouts Origins Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SPRO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SPRO addresses"));
    ...
    openAction->setStatusTip(tr("Open a sproutsorigins: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sprouts Origins Coin help message to get a list with possible Sprouts Origins Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/sproutsorigins_logo_horizontal").pixmap(210, 50));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Sprouts Origins Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sprouts Origins network", "", count));
}
...
{
    QString strTitle = tr("Sprouts Origins Core"); // default title
    ...
    // Append title to "Sprouts Origins Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
