...
/** Class encapsulating Sprouts Core startup and shutdown.
...
/** Main Sprouts application object */
...
public:
    ...
    /// Get window identifier of QMainWindow (SproutsGUI)
...
void BitcoinApplication::initializeResult(int retval)
{
    ...
    if (retval) {
        ...
        // Sprouts: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", QObject::tr("A fatal error occurred. Sprouts-Origins can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
...
/// 2. Basic Qt initialization (not dependent on parameters or configuration)
    ...
    /// 6. Determine availability of data directory and parse Sprouts-Origins.conf
    ...
    // Sprouts-Origins: links repeatedly have their payment requests routed to this process:
