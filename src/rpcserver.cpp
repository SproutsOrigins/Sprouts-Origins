...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Sprouts Origins server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Sprouts Origins server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Sprouts Origins features */
        {"sproutsorigins", "masternode", &masternode, true, true, false},
        {"sproutsorigins", "listmasternodes", &listmasternodes, true, true, false},
        {"sproutsorigins", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sproutsorigins", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sproutsorigins", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sproutsorigins", "masternodedebug", &masternodedebug, true, true, false},
        {"sproutsorigins", "startmasternode", &startmasternode, true, true, false},
        {"sproutsorigins", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sproutsorigins", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sproutsorigins", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sproutsorigins", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sproutsorigins", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sproutsorigins", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sproutsorigins", "mnbudget", &mnbudget, true, true, false},
        {"sproutsorigins", "preparebudget", &preparebudget, true, true, false},
        {"sproutsorigins", "submitbudget", &submitbudget, true, true, false},
        {"sproutsorigins", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sproutsorigins", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sproutsorigins", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sproutsorigins", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sproutsorigins", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sproutsorigins", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sproutsorigins", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sproutsorigins", "checkbudgets", &checkbudgets, true, true, false},
        {"sproutsorigins", "mnsync", &mnsync, true, true, false},
        {"sproutsorigins", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> sproutsorigins-cli " + methodname + " " + args + "\n";
}
