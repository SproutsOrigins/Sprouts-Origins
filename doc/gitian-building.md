...
*Setup instructions for a gitian build of Sprouts-Origins Core using a VM or physical system.*
...
to the Sprouts-Origins GitHub release page.
...
- [Building Sprouts-Origins Core](#building-Sprouts-Origins-core)
