...
The build script we'll be using is contained in the Sprouts-Origins github repository ([contrib/gitian-build.py](https://github.com/sappcoin-com/sapp/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Sprouts-Origins repository and will need to fetch this script with the following commands:
...
- Clone the gitian-builder, gitian.sigs, pivx-detached-sigs, and Sprouts-Origins GitHub repos.
