...
Sprouts Origins now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<sproutsorigins_address\> \<monthly_payment_sproutsorigins\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ SPRO, _12_ times over the course of a year totaling _24000_ SPRO.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<sproutsorigins_address\> \<monthly_payment_sproutsorigins\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` SPRO.
 ...
 * vote-many          - Vote on a Sprouts Origins initiative
 * vote-alias         - Vote on a Sprouts Origins initiative
 * vote               - Vote on a Sprouts Origins initiative/budget
