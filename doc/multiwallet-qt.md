...
In order to support loading of multiple wallets in sproutsorigins-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sproutsorigins.cpp.
...
Changes to sproutsorigins.cpp
----------------------
sproutsorigins.cpp is the entry point into sproutsorigins-qt, and as such, will require some minor modifications to provide hooks for
