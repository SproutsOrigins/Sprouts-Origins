...
Intro
-----
Sprouts Origins (SPRO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Sprouts Origins utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run sproutsorigins-qt.exe.

Sprouts Origins Core is the original Sprouts Origins client and it builds the backbone of the network.
However, it downloads and stores the entire history of Sprouts Origins transactions;
