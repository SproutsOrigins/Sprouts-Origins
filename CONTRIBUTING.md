Contributing to Sprouts-Origins Core
============================

The Sprouts-Origins Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Sprouts-Origins Core project, and is not to be
confused with overall Sprouts-Origins Network Protocol consensus changes.

Whether a pull request is merged into Sprouts-Origins Core rests with the project merge
...
Patches that change Sprouts-Origins consensus rules are considerably more involved than
...
Where a patchset proposes to change the Sprouts-Origins consensus, it must have been
...
The project leader is the release manager for each Sprouts-Origins Core release.
