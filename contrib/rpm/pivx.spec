...
#man pages
Source20:	https://raw.githubusercontent.com/sappcoin-com/sapp/v%{version}/doc/man/Sprouts-Originsd.1
Source21:	https://raw.githubusercontent.com/sappcoin-com/sapp/v%{version}/doc/man/Sprouts-Origins-cli.1
Source22:	https://raw.githubusercontent.com/sappcoin-com/sapp/v%{version}/doc/man/Sprouts-Origins-qt.1
...
# man pages
install -D -p %{SOURCE20} %{buildroot}%{_mandir}/man1/Sprouts-Originsd.1
install -p %{SOURCE21} %{buildroot}%{_mandir}/man1/Sprouts-Origins-cli.1
%if %{_buildqt}
install -p %{SOURCE22} %{buildroot}%{_mandir}/man1/Sprouts-Origins-qt.1
%endif
...
%attr(0644,root,root) %{_mandir}/man1/Sprouts-Origins-qt.1*
%endif
...
%attr(0644,root,root) %{_mandir}/man1/Sprouts-Originsd.1*
...
%attr(0644,root,root) %{_mandir}/man1/Sprouts-Origins-cli.1*
