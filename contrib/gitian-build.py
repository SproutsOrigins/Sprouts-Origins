...
def setup_repos():
    ...
    if not os.path.isdir('pivx'):
        subprocess.check_call(['git', 'clone', 'https://github.com/sappcoin-com/Sprouts.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/sappcoin-com/Sprouts', help='Specify the URL of the repository. Default is %(default)s')
